  ...
  return (
    <Link href={`/movies/${id}`} asChild>
        ...
        >
            ...
            <Text
                className='text-sm font-bold text-white text-center mt-1'
                numberOfLines={1}
            >
                {title}
            </Text>
            ...
            >
                ...
                >
                    {vote_count ? vote_average.toFixed(1) : "No Ratings"}
                </Text>
            </View>
            <View
            ...
            >
                ...
                <Text
                    className='text-xs font-medium text-light-300 uppercase'
                >
                    Movie
                </Text>
            </View>
